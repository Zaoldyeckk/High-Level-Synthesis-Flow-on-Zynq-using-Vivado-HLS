# 1 "D:/High-Level-Synthesis-Flow-on-Zynq-using-Vivado-HLS/source/lab2/yuv_filter.prj/solution1/.autopilot/db/yuv_filter.pragma.1.c"
# 1 "D:/High-Level-Synthesis-Flow-on-Zynq-using-Vivado-HLS/source/lab2/yuv_filter.prj/solution1/.autopilot/db/yuv_filter.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "D:/High-Level-Synthesis-Flow-on-Zynq-using-Vivado-HLS/source/lab2/yuv_filter.prj/solution1/.autopilot/db/yuv_filter.pragma.1.c" 2
# 1 "yuv_filter.c"
# 1 "yuv_filter.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
